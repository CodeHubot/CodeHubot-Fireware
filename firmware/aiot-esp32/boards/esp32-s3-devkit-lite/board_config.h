/**
 * @file board_config.h
 * @brief ESP32-S3 DevKit Lite 开发板配置（精简版）
 * 
 * 定义ESP32-S3 DevKit Lite版本的硬件配置，包括GPIO映射、外设配置等
 * Lite版本仅保留基础功能：DHT11传感器、LED、继电器、PWM输出
 * 
 * GPIO引脚映射表:
 * ┌─────────────┬──────────┬─────────────────────┐
 * │   功能      │  标识    │      GPIO引脚       │
...
// ==================== 板级基本信息 ====================
#define BOARD_NAME          "ESP32-S3-DevKit-Lite"
...
// ==================== 舵机配置 ====================
#define SERVO_COUNT         0  // Lite版本没有舵机
...
#define DEFAULT_DEVICE_ID   "esp32s3_devkit_lite_001"
