/**
 * @file board_config.h
 * @brief ESP32-S3 DevKit 开发板配置
 * 
 * 定义ESP32-S3开发板的硬件配置，包括GPIO映射、外设配置等
 * 
 * GPIO引脚映射表:
 * ┌─────────────┬──────────┬─────────────────────┐
 * │   功能      │  标识    │      GPIO引脚       │
...
// 舵机1配置 (M1 - G48)
#define SERVO1_GPIO_PIN     GPIO_NUM_48
#define SERVO1_FREQUENCY    50      // 50Hz
#define SERVO1_MIN_PULSE_US 500     // 0.5ms
#define SERVO1_MAX_PULSE_US 2500    // 2.5ms
#define SERVO1_MAX_ANGLE    180     // 180度
...
#define DEFAULT_DEVICE_ID   "esp32s3_devkit_001"
