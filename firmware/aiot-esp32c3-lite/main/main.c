...
static const char* config_page_html = 
    ...
    "<div style='position:absolute;left:14px;top:50%;transform:translateY(-50%);color:#999;font-size:14px;pointer-events:none'>http://</div>"
    "<input type='text' name='config_srv' value='conf.aiot.powertechhub.com:8001' required "
    "style='padding-left:65px;width:100%'>"
    "</div>"
    "<div style='font-size:12px;color:#999;margin-top:4px'>示例: conf.aiot.powertechhub.com:8001</div>"
    "</div>"
